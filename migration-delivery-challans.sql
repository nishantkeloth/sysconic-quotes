...
create table if not exists delivery_challans (
  ...
  -- The PO the CUSTOMER sent Sysconic to confirm this order (not a vendor
  -- PO -- those live in zoho_purchase_orders and are unrelated). Manually
  -- typed for now; pre-filled from projects.po_number when available.
